...
# the ungroup() is used to avoid errors if any later functions do not know how to handle grouped data.
# Would it be helpful to add the text "...the effect of BB (while also adjusting for HR) on runs over time..." to the question?
